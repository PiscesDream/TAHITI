...
//    if (mem_addr == 0) mem_addr = 0x100000;
//kprintf("addr: %x, size: %x, ret: %x\n", mem_addr, size, mem_addr+size);
...
void init_heap() {
    mem_addr = 0x100000;  // linear usage of kernel memory
    mem_addr_end = 0x400000;  
